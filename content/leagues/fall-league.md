...
faq:
  ...
  - q: "What makes FCP Sports leagues different from the city rec league?"
    a: "The Fort Walton Beach rec league typically costs $30-50 and uses school gyms, volunteer referees, and does not track stats. FCP Sports leagues are played in our dedicated basketball facility with trained, paid referees, per-game stat tracking, online standings, post-game coaching sessions, and a real game atmosphere with scoreboard and PA system. We also draft teams for competitive balance so no one stacks a roster."
...
This is not a rec center drop-in. It is an 8-week season with standings, playoffs, and trophies. Every game is played in our dedicated basketball facility with a scoreboard, PA system, and trained referees. Military families from Eglin AFB and Hurlburt Field are welcome and receive a discount.
...
We draft teams for competitive balance. Every player is evaluated and placed on a team so that the league stays competitive from week one through the playoffs. You can request to play with a friend, but all requests are subject to draft balance. No one gets to stack a roster.
...
[Register now](/registration/) to lock in your spot. Divisions fill up, especially Mini and Junior. If you have questions about which division is right for your child, [contact us](/contact/) and we will help you figure it out.

Between seasons, keep your child developing with our [basketball training programs](/services/basketball-training/), [camps](/camps/), or [open gym sessions](/services/open-gym/).
